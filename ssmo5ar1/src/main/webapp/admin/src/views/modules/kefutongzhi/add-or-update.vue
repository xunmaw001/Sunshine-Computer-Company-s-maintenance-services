...
export default {
  ...
  methods: {
	...
	this.ruleForm.tongzhineirong = this.ruleForm.tongzhineirong.replace(reg,'../../../ssmo5ar1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kefutongzhi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kefutongzhiCrossAddOrUpdateFlag = false;
                  this.parent.search();
