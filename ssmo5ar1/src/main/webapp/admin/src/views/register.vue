  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(30, 136, 229, 1);fontSize:28px;">维修服务微信小程序注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210313/f3462c74030f4804b6b10ad942b2fd21.jpg");
		height: 100vh;
